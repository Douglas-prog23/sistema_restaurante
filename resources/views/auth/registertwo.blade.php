                ...
                <div class="col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8 ">
                    <div class="form-container ">
                        ...
                        <form class="form-horizontal" method="post" action="{{ route('usuario.save') }}">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 ">
                                    ...
                                    <input type="text" class="form-control @error('username') is-invalid @enderror"
                                        placeholder="Ejemplo: Juan2044" name="username" value="{{ old('username') }}" required
                                ...
                                <div class="form-group col-md-6 ">
                                    ...
                                    <input id="email" type="email"
                                        class="form-control @error('email') is-invalid @enderror" placeholder="example@test.com"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 ">
                                    ...
                                    <input id="password" type="password"
                                        class="toggle-password form-control @error('password') is-invalid @enderror"
                                        placeholder="Escribe una contraseña" name="password" required
                                ...
                                <div class="form-group col-md-6 ">
                                    ...
                                    <input id="password-confirm" type="password" class="form-control toggle-password"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 ">
                                    ...
                                    <input id="name" type="text"
                                        ...
                                        placeholder="Escribe tu apellido" name="lastname" value="{{ old('lastname') }}" required
                            ...
                            {{-- ----------------------------------------------- --}}
                            <div class="row">
                                <div class="form-group col-md-6 phone-no ">
                                    <label>Telefono*</label>
                                    <input type="text" class="form-control @error('telephone') is-invalid @enderror"
                                        placeholder="Ejemplo: 0948-0597" name="telephone" value="{{ old('telephone') }}"
                            ...
                            {{-- /////////////////////////////////////////////////////// --}}
                            <input type="submit" class="btn signin" value="{{ __('Registrar Usuario') }}">
                        </form>
                    </div>
                </div>
            </div>
