...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card" style="background: rgba(19, 19, 19, 0.63)">
                    ...
                    <div class="card-body" style="background: rgba(19, 19, 19, 0.63); -webkit-box-shadow:  1px 1px 5px 3px rgba(255, 255, 255, 0.2);
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('categorias.destroy',$categoria->id) }}" method="POST">
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('¿Estas seguro de eliminar esta categoria?'); false"><i class="fa fa-fw fa-trash"></i> {{ __('Delete') }}</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
