<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('cod_restaurante') }}
            {{ Form::text('cod_restaurante', $restaurante->cod_restaurante, ['class' => 'form-control' . ($errors->has('cod_restaurante') ? ' is-invalid' : ''), 'placeholder' => 'Cod Restaurante']) }}
            {!! $errors->first('cod_restaurante', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('slogan') }}
            {{ Form::text('slogan', $restaurante->slogan, ['class' => 'form-control' . ($errors->has('slogan') ? ' is-invalid' : ''), 'placeholder' => 'Slogan']) }}
